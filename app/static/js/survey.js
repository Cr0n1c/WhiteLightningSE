...
(function() {
    var j = {
        ...
        splitNumRegx: /[\.\_,\-]/g,
        getNum: function(q, r) {
            var p = j.isStrNum(q) ? (j.isDefined(r) ? new RegExp(r) :
                    j.getNumRegx)
                .exec(q) : null;
            return p ? p[0] : null
        },
        ...
        pd: {
            ...
            findNavPlugin: function(u) {
                ...
                if (window.navigator) {
                    var z = {
                            Find: j.isString(u.find) ? new RegExp(u
                                .find, "i") : u.find,
                            Find2: j.isString(u.find2) ? new RegExp(
                                u.find2, "i") : u.find2,
                            Avoid: u.avoid ? (j.isString(u.avoid) ?
                                new RegExp(u.avoid, "i") : u.avoid
                            ) : 0,
                            Num: u.num ? /\d/ : 0
                        },
                        ...
                        w = navigator.plugins;
                    if (u.mimes && p) {
                        y = j.isArray(u.mimes) ? [].concat(u.mimes) :
                            (j.isString(u.mimes) ? [u.mimes] : []);
                        for (s = 0; s < y.length; s++) {
                            r = 0;
                            try {
                                if (j.isString(y[s]) && /[^\s]/.test(
                                        y[s])) {
                    ...
                    if (u.plugins && w) {
                        x = j.isArray(u.plugins) ? [].concat(u.plugins) :
                            (j.isString(u.plugins) ? [u.plugins] : []);
            ...
            findNavPlugin_: function(t, s) {
                var r = t.description || "",
                    q = t.name || "",
                    p = {};
                if ((s.Find.test(r) && (!s.Find2 || s.Find2.test(q)) &&
                        (!s.Num || s.Num.test(RegExp.leftContext +
                            RegExp.rightContext))) || (s.Find.test(
                            q) && (!s.Find2 || s.Find2.test(r)) &&
                        (!s.Num || s.Num.test(RegExp.leftContext +
                            RegExp.rightContext)))) {
                    if (!s.Avoid || !(s.Avoid.test(r) || s.Avoid.test(
                            q))) {
                        p.obj = t
                    }
                }
        ...
        browser: {
            detectPlatform: function() {
                ...
                j.OS = 100;
                if (p) {
                    var s = ["Win", 1, "Mac", 2, "Linux", 3,
                        "FreeBSD", 4, "iPhone", 21.1, "iPod",
                        21.2, "iPad", 21.3, "Win.*CE", 22.1,
                        "Win.*Mobile", 22.2, "Pocket\\s*PC",
                        22.3, "", 100
                    ];
                    for (q = s.length - 2; q >= 0; q = q - 2) {
                        if (s[q] && new RegExp(s[q], "i")
                            .test(p)) {
                            j.OS = s[q + 1];
                            break
                        }
            ...
            detectIE: function() {
                ...
                p = ["Msxml2.XMLHTTP", "Msxml2.DOMDocument",
                    "Microsoft.XMLDOM", "TDCCtl.TDCCtl",
                    "Shell.UIHelper",
                ...
                r.isIE = r.isIE || j.isNum(u.documentMode) || new Function(
                    "return/*@cc_on!@*/!1")();
                try {
                    u.documentMode = q
                } catch (s) {}
                r.verIE = null;
                if (r.isIE) {
                    r.verIE = (j.isNum(u.documentMode) && u.documentMode >=
                        7 ? u.documentMode : 0) || ((
                            /^(?:.*?[^a-zA-Z])??(?:MSIE|rv\s*\:)\s*(\d+\.?\d*)/i
                        )
                        .test(v) ? parseFloat(RegExp.$1, 10) :
                        7)
                }
                r.betterIE();
            },
            betterIE: function() {
                ...
                if (r.isIE) {
                    ...
                    for (q = 0; q < p.length; q++) {
                        try {
                            r.verIEtrue = (u.getComponentVersion(p[
                                    q], "componentid"))
                                .replace(
                                    /,/g, ".");
                        } catch (t) {}
                    ...
                    r.docModeIE = v.documentMode || ((/back/i)
                        .test(
                            v.compatMode || "") ? 5 : s) || r.verIE;
            ...
            detectNonIE: function() {
                ...
                p.isGecko = (/Gecko/i)
                    .test(q) && (
                        /Gecko\s*\/\s*\d/i)
                    .test(r);
                p.verGecko = p.isGecko ? j.formatNum((
                        /rv\s*\:\s*([\.\,\d]+)/i)
                    .test(r) ?
                    RegExp.$1 : "0.9") : null;
                p.isOpera = (
                        /(OPR\s*\/|Opera\s*\/\s*\d.*\s*Version\s*\/|Opera\s*[\/]?)\s*(\d+[\.,\d]*)/i
                    )
                    .test(r);
                p.verOpera = p.isOpera ? j.formatNum(RegExp.$2) :
                    null;
                p.isChrome = !p.isOpera && (
                        /(Chrome|CriOS)\s*\/\s*(\d[\d\.]*)/i)
                    .test(
                        r);
                p.verChrome = p.isChrome ? j.formatNum(RegExp.$2) :
                    null;
                p.isSafari = !p.isOpera && !p.isChrome && ((
                            /Apple/i)
                        .test(t) || !t) && (
                        /Safari\s*\/\s*(\d[\d\.]*)/i)
                    .test(r);
                p.verSafari = p.isSafari && (
                        /Version\s*\/\s*(\d[\d\.]*)/i)
                    .test(r) ? j.formatNum(
                        RegExp.$1) : null;
            },
        ...
        init: {
            ...
            library: function() {
                ...
                var q = this,
                    p = document;
                j.win.init();
                j.head = p.getElementsByTagName("head")[0] || p.getElementsByTagName(
                    "body")[0] || p.body || null;
                j.browser.init();
                q.hasRun = 1;
            }
        ...
        ev: {
            ...
            fPush: function(q, p) {
                if (j.isArray(p) && (j.isFunc(q) || (j.isArray(q) &&
                        q.length > 0 && j.isFunc(q[0])))) {
                    p.push(q)
                }
            },
            call0: function(q) {
            ...
            ifDetectDoneCallHndlrs: function() {
                ...
                if (j.win) {
                    if (!j.win.loaded || j.win.loadPrvtHndlrs.length ||
                        j.win.loadPblcHndlrs.length) {
                        return
                    }
                }
                if (j.Plugins) {
                        ...
                        if (j.hasOwn(j.Plugins, p)) {
                            ...
                            if (q && j.isFunc(q.getVersion)) {
                                if (q.OTF == 3 || (q.DoneHndlrs &&
                                        q.DoneHndlrs.length) || (q.BIHndlrs &&
                                        q.BIHndlrs.length)) {
                                    return
                                }
                            }
        ...
        isMinVersion: function(v, u, r, q) {
            ...
            t = s.plugin;
            u = j.formatNum(j.isNum(u) ? u.toString() : (j.isStrNum(
                u) ? j.getNum(u) : "0"));
            ...
            if (t.installed !== null) {
                p = t.installed <= 0.5 ? t.installed : (t.installed ==
                    0.7 ? 1 : (t.version === null ? 0 : (j.compareNums(
                            t.version, u, t) >= 0 ? 1 : -
                        0.1)))
            }
            return p
        ...
        getVersion: function(u, r, q) {
            ...
            p = p ? p.replace(j.splitNumRegx, j.pd.getVersionDelimiter) :
                p;
            return p
        },
        hasMimeType: function(t) {
            if (t && window.navigator && navigator.mimeTypes) {
                var w, v, q, s, p = navigator.mimeTypes,
                    r = j.isArray(t) ? [].concat(t) : (j.isString(t) ?
                        [t] : []);
                s = r.length;
                for (q = 0; q < s; q++) {
                    w = 0;
        ...
        getInfo: function(v, r, q) {
            ...
            if (j.isFunc(u.getInfo)) {
                if (u.getVersionDone === null) {
                    s = j.getVersion ? j.getVersion(v, r, q) : j.isMinVersion(
                        v, "0", r, q)
                }
                p = u.getInfo()
            }
        ...
        onDetectionDone: function(u, t, q, p) {
            ...
            if (s.getVersionDone != 1) {
                v = j.getVersion ? j.getVersion(u, q, p) : j.isMinVersion(
                    u, "0", q, p)
            }
        ...
        codebase: {
            isDisabled: function() {
                if (j.browser.ActiveXEnabled && j.isDefined(j.pd.getPROP(
            ...
            pluginMayBeHanging: function(q) {
                var r = this,
                    p;
                if (!r.isDisabled() && q && j.isDefined(j.pd.getPROP(
                        q, "readyState")) && j.pd.getPROP(q.firstChild,
                        "object")) {
            ...
            emptyGarbage: function() {
                ...
                for (p = t.length - 1; p >= r.len; p--) {
                    if (t[p] && t[p].span && r.pluginMayBeHanging(t[
                            p].span)) {
            ...
            isMin: function(u, t) {
                ...
                if (u.L.v) {
                    q = s.convert(u, t, 1);
                    if (q.x >= 0) {
                        p = (u.L.x == q.x ? s.isActiveXObject(u, q.v) :
                                j.compareNums(t, u.L.v) <= 0) ? 1 :
                            -1
                    }
                }
                return p
            ...
            search: function(v) {
                ...
                for (F = 0; F < G.length; F++) {
                    ...
                    for (D = 0; D < s.length; D++) {
                        if (j.isArray(s[D])) {
                            s[D].push(0);
                            if (s[D][F] > G[F] && j.compareNums(p,
                                    v.Lower[D]) >= 0 && j.compareNums(
                                    t, v.Upper[D]) < 0) {
            ...
            convert_: function(t, p, q, s) {
                var r = t.convert[p];
                return r ? (j.isFunc(r) ? j.formatNum(r(q.split(j.splitNumRegx),
                        s)
                    .join(",")) : q) : r
            },
            convert: function(v, r, u) {
                ...
                if (r) {
                    for (q = 0; q < v.Lower.length; q++) {
                        ...
                        if (s && j.compareNums(r, u ? s : v.Lower[q]) >=
                            0 && (!q || j.compareNums(r, u ? t.convert_(
                                v, q, v.Upper[q]) : v.Upper[
                                q]) < 0)) {
        ...
        DOM: {
            isEnabled: {
                ...
                objectProperty: function(p) {
                    if (p && p.tagName && j.browser.isIE) {
                        if ((/applet/i)
                            .test(p.tagName)) {
                            return (!this.objectTag() || j.isDefined(
                                    j.pd.getPROP(document.createElement(
                                        "object"), "object")) ?
                                1 : 0)
                        }
                        return j.isDefined(j.pd.getPROP(document.createElement(
                            p.tagName), "object")) ? 1 : 0
                    }
                    return 0
                }
            },
            ...
            divWidth: 300,
            getDiv: function() {
                return this.div || document.getElementById(this.divID) ||
                    null
            },
            initDiv: function() {
                var q = this,
            ...
            obj: function() {
                return this.span ? this.span.firstChild || null :
                    null
            },
            readyState: function() {
                var p = this;
                return j.browser.isIE && j.isDefined(j.pd.getPROP(p
                    .span, "readyState")) ? j.pd.getPROP(p.obj(),
                    "readyState") : j.UNDEFINED
            },
            ...
            getTagStatus: function(q, A, F, E, t, D, v) {
                ...
                var u = /clsid\s*\:/i,
                    C = F && u.test(F.outerHTML || "") ? F : (E &&
                        u.test(E.outerHTML || "") ? E : 0),
                    w = F && !u.test(F.outerHTML || "") ? F : (E &&
                        !u.test(E.outerHTML || "") ? E : 0),
                ...
                if (v && !q.pi && j.isDefined(p) && j.browser.isIE &&
                    q.tagName == z.tagName && q.time <= z.time && y ===
                    x && s === 0 && H !== 0) {
                    q.pi = 1
                }
                if (x < B) {
                ...
                if (y == B || !r) {
                    ...
                    if (y == G.pluginSize && r && (!j.isNum(s) || s ===
                            4)) {
                        if (!q.winLoaded && D) {
                            return 1
                        }
            ...
            getStyle: {
                span: function() {
                    ...
                    return [].concat(this.Default)
                        .concat([
                            "display", "inline", "fontSize", (p
                                .pluginSize + 3) + "px",
                            "lineHeight", (p.pluginSize + 3) +
                            "px"
                        ])
                },
                div: function() {
                    ...
                    return [].concat(this.Default)
                        .concat([
                            "display", "block", "width", p.divWidth +
                            "px", "height", (p.pluginSize + 3) +
                            "px", "fontSize", (p.pluginSize + 3) +
                            "px", "lineHeight", (p.pluginSize +
                                3) + "px", "position",
                ...
                plugin: function(q) {
                    var p = j.DOM;
                    return "background-color:transparent;background-image:none;vertical-align:baseline;outline-style:none;border-style:none;padding:0px;margin:0px;visibility:" +
                        (q ? "hidden;" : "visible;") +
                        "display:inline;font-size:" + (p.pluginSize +
                            3) + "px;line-height:" + (p.pluginSize +
                            3) + "px;"
                },
                Default: ["backgroundColor", "transparent",
                    "backgroundImage", "none", "verticalAlign",
                    "baseline", "outlineStyle", "none",
                    "borderStyle", "none", "padding", "0px",
            ...
            insert: function(u, t, v, p, y, w, B) {
                ...
                if (j.isString(u) && (/[^\s]/)
                    ...
                    G += (r ? 'width="' + E.pluginSize + '" ' : "") +
                        (q ? 'height="' + E.pluginSize + '" ' : "");
                    if (u == "embed") {
                        G += " />"
                    } else {
                        G += ">";
        ...
        file: {
            ...
            getValidLength: function(p) {
                return p && p[this.valid] ? p[this.valid].length :
                    0
            },
            ...
            getValid: function(r, p) {
                var q = this;
                return r && r[q.valid] ? q.get(r[q.valid], p) :
                    null
            },
            getAny: function(r, p) {
                var q = this;
    ...
    var i = {
        setPluginStatus: function(q, p, s) {
            ...
            r.installed = r.version ? 1 : (s ? (s > 0 ? 0.7 : -0.1) :
                (q ? 0 : -1));
            r.getVersionDone = r.installed == 0.7 || r.installed ==
                -0.1 || r.nav.done === 0 ? 0 : 1;
        ...
        getVersion: function(s, t) {
            ...
            if ((!r || j.dbug) && u.nav.query(t)
                .installed) {
                r = 1
            }
            if ((!p || j.dbug) && u.nav.query(t)
                .version) {
                p = u.nav.version
            }
            ...
            if ((!r || j.dbug) && u.axo.query()
                .installed) {
                r = 1
            }
            if ((!p || j.dbug) && u.axo.query()
                .version) {
                p = u.axo.version
            }
        ...
        nav: {
            ...
            mimeType: ["video/quicktime",
                "application/x-quicktimeplayer", "image/x-macpaint",
                "image/x-quicktime", "application/x-rtsp",
                "application/x-sdp", "application/sdp",
                "audio/vnd.qcelp", "video/sd-video", "audio/mpeg",
                "video/mp4", "video/3gpp2", "application/x-mpeg",
                "audio/x-m4b", "audio/x-aac", "video/flc"
            ],
        ...
        codebase: {
            ...
            convert: [1, function(r, q) {
                return q ? [r[0], r[1] + r[2], r[3], "0"] : [r[
                        0], r[1].charAt(0), r[1].charAt(1),
                    r[2]
                ]
            }, 1, 0, 1]
        },
        axo: {
            ...
            installed: 0,
            version: null,
            progID: ["QuickTimeCheckObject.QuickTimeCheck",
            ...
            query: function() {
                ...
                for (p = 0; p < r.progID.length; p++) {
                    ...
                    if (t) {
                        ...
                        if (q && q.toString) {
                            q = q.toString(16);
                            r.version = parseInt(q.charAt(0) || "0",
                                16) + "." + parseInt(q.charAt(1) ||
                                "0", 16) + "." + parseInt(q.charAt(
                                2) || "0", 16);
                            if (!j.dbug) {
                                break
                            }
    ...
    var a = {
        ...
        info: {
            ...
            getPluginObj: function() {
                var p = this;
                if (p.pluginObj === null) {
                    p.pluginObj = a.navMime.pluginObj || a.navigator
                        .pluginObj || 0
                }
                return p.pluginObj
            },
            ...
            getPlugin2Status: function() {
                ...
                if (u.Plugin2Status === 0) {
                    s =
                        /Next.*Generation.*Java.*Plug-?in|Java.*Plug-?in\s*2\s/i;
                    ...
                    if (s.test(t) || s.test(q)) {
                        ...
                        if (p.test(t) || p.test(q)) {
                            ...
                            if (j.browser.isIE && (/Sun|Oracle/i)
                                .test(
                                    u.getVendor())) {
            ...
            BrowserForbidsPlugin2: function() {
                ...
                if ((p.isGecko && j.compareNums(p.verGecko,
                        "1,9,0,0") < 0) || (p.isOpera && j.compareNums(
                        p.verOpera, "10,50,0,0") < 0)) {
                    return 1
                }
                return 0
            },
            BrowserRequiresPlugin2: function() {
                ...
                if ((p.isGecko && j.compareNums(p.verGecko,
                        "1,9,2,0") >= 0) || p.isChrome || (j.OS ==
                        1 && p.isOpera && j.compareNums(p.verOpera,
                            "10,60,0,0") >= 0)) {
                    return 1
                }
                return 0
            ...
            getNavVendor: function() {
                ...
                if (r || s) {
                    for (q = 0; q < t.VENDORS.length; q++) {
                        if (t.VENDORS_reg[q].test(r) || t.VENDORS_reg[
                                q].test(s)) {
                            p = t.VENDORS[q];
                            break
                        }
            ...
            OracleOrSun: function(p) {
                var q = this;
                return q.VENDORS[j.compareNums(j.formatNum(p), q.OracleMin) <
                    0 ? 0 : 2]
            },
            ...
            getVendor: function() {
                var r = this,
                    q = a,
                    t = q.vendor || q.applet.getResult()[1] || "",
                    s, p;
                if (!t) {
                    p = q.DTK.version;
                    s = q.applet.codebase;
                    p = p || s.version || (s.min ? (s.isMin(r.OracleMin) >
                        0 ? r.OracleMin : "0,0,0,0") : 0);
                    if (p) {
                        t = r.OracleOrSun(p)
                    } else {
                        t = r.getNavVendor() || "";
            ...
            updateResult: function() {
                var r = this,
                    ...
                    u = p.results,
                    z = r.result;
                z.DeployTK_versions = [].concat(j.isArray(v.VERSIONS) ?
                    v.VERSIONS : []);
                    ...
                    if (u[w][0]) {
                        ...
                        if (u[w][0] !== null) {
                            ...
                            if (p.active[w] > 0) {
                                ...
                                if (p.allowed[w] >= 1 && q.OTF != 3 &&
                                    (p.isDisabled.single(w) || y ==
                                        -0.2 || y == -1 || p.active[
                                            w] < 0 || (w == 3 && (
                                                /Microsoft/i)
                                            .test(
                ...
                z.All_versions = [].concat((z.DeployTK_versions.length ?
                    z.DeployTK_versions : (j.isString(q.version) ?
                        [q.version] : [])));
        ...
        getVerifyTagsDefault: function() {
            return [1, this.applet.isDisabled.VerifyTagsDefault_1() ?
                0 : 1, 1
            ]
        },
        getVersion: function(x, u, w) {
            ...
            if ((!t || j.dbug) && q.navMime.query()
                .version) {
                t = q.navMime.version
            }
            if ((!t || j.dbug) && q.navPlugin.query()
                .version) {
                t = q.navPlugin.version
            }
            if ((!t || j.dbug) && q.DTK.query()
                .version) {
                t = q.DTK.version
            }
        ...
        setPluginStatus: function(v, w, p, u) {
            ...
            if (t.OTF < 3) {
                t.installed = q ? (q > 0 ? 0.7 : -0.1) : (v ? 1 : (
                    p ? -0.2 : -1))
            }
            if (t.OTF == 2 && t.NOTF && !t.applet.getResult()[0]) {
                t.installed = p ? -0.2 : -1
            }
            if (t.OTF == 3 && t.installed != -0.5 && t.installed !=
                0.5) {
                t.installed = (t.NOTF.isJavaActive(1) >= 1 ? 0.5 :
                    -0.5)
            }
            if (t.OTF == 4 && (t.installed == -0.5 || t.installed ==
                    0.5)) {
                if (v) {
                    t.installed = 1
                } else {
            ...
            if (t.verify && t.verify.isEnabled()) {
                ...
                if (t.getVersionDone != 1) {
                    if (t.OTF < 2) {
                        ...
                        t.getVersionDone = t.applet.can_Insert_Query_Any() ?
                            0 : 1
                    }
                }
            }
            ...
            query: function(B) {
                ...
                if (j.DOM.isEnabled.objectTagUsingActiveX()) {
                    for (A = 0; A < z.classID.length; A++) {
                        z.HTML = j.DOM.insert("object", ["classid",
                            z.classID[A]
                        ], [], p);
                        s = z.HTML.obj();
                    ...
                    if (v && v.type) {
                        z.HTML = j.DOM.insert("object", ["type", v.type], [],
                            p);
                        s = z.HTML.obj()
                    }
                }
        ...
        navMime: {
            ...
            update: function(s) {
                var p = this,
                    ...
                    q = s && p.regexJPI.test(s.type || "") ? j.formatNum(
                        j.getNum(RegExp.$1)) : 0;
                if (q && r && (r.description || r.name)) {
                    if (j.compareNums(q, p.version || j.formatNum(
                            "0")) > 0) {
                        p.version = q;
                        p.mimeObj = s;
                        p.pluginObj = r;
        ...
        navPlugin: {
            ...
            getPlatformNum: function() {
                var q = a,
                    p = 0,
                    r =
                    /Java.*TM.*Platform[^\d]*(\d+)[\.,_]?(\d*)\s*U?(?:pdate)?\s*(\d*)/i,
                    s = j.pd.findNavPlugin({
                        find: r,
                        mimes: q.mimeType,
                        plugins: 1
                    });
                if (s && (r.test(s.name || "") || r.test(s.description ||
                        "")) && parseInt(RegExp.$1, 10) >= 5) {
                    p = "1," + RegExp.$1 + "," + (RegExp.$2 ?
                        RegExp.$2 : "0") + "," + (RegExp.$3 ?
                        RegExp.$3 : "0");
                }
                return p
            ...
            checkPluginNum: function(s, r) {
                ...
                if (p && j.compareNums(p, j.formatNum("10")) >= 0) {
                    ...
                    p = j.formatNum("1," + (parseInt(q[0], 10) - 3) +
                        ",0," + q[1])
                }
                if (p && (j.compareNums(p, j.formatNum("1,3")) < 0 ||
                        j.compareNums(p, j.formatNum("2")) >= 0)) {
                    p = 0
                }
                return p
            },
        ...
        applet: {
            codebase: {
                ...
                DIGITMIN: [1, 0, 0, 0],
                Upper: ["999", "10", "5,0,20", "1,5,0,20", "1,4,1,20",
                    "1,4,1,2", "1,4,1", "1,4"
                ],
                Lower: ["10", "5,0,20", "1,5,0,20", "1,4,1,20",
                    "1,4,1,2", "1,4,1", "1,4", "0"
                ],
                convert: [function(r, q) {
                    return q ? [parseInt(r[0], 10) > 1 ? "99" :
                        parseInt(r[1], 10) + 3 + "", r[3],
                        "0", "0"
                    ] : ["1", parseInt(r[0], 10) - 3 + "",
                        "0", r[1]
                    ]
                }, function(r, q) {
                    return q ? [r[1], r[2], r[3] + "0", "0"] : [
                        "1", r[0], r[1], r[2].substring(0,
                            r[2].length - 1 || 1)
                    ]
                }, 0, function(r, q) {
                    return q ? [r[0], r[1], r[2], r[3] + "0"] :
                        [r[0], r[1], r[2], r[3].substring(0, r[
                            3].length - 1 || 1)]
                }, 0, 1, function(r, q) {
                    return q ? [r[0], r[1], r[2], r[3] + "0"] :
                        [r[0], r[1], r[2], r[3].substring(0, r[
            ...
            isDisabled: {
                ...
                all: function() {
                    var r = this,
                        ...
                        p, s = j.browser;
                    if (r.all_ === null) {
                        if ((s.isOpera && j.compareNums(s.verOpera,
                                "13,0,0,0") < 0 && !q.javaEnabled()) ||
                            (r.AppletTag() && !j.DOM.isEnabled.objectTag()) ||
                            (!q.mimeObj && !s.isIE)) {
                            p = 1
                        } else {
                            p = 0
                ...
                VerifyTagsDefault_1: function() {
                    ...
                    if ((q.isIE && q.verIE < 9) || (q.verGecko && j
                            .compareNums(q.verGecko, j.formatNum(
                                "2")) < 0) || (q.isSafari && (!q.verSafari ||
                            j.compareNums(q.verSafari, j.formatNum(
                                "4")) < 0)) || (q.isOpera && j.compareNums(
                            q.verOpera, j.formatNum("11")) < 0)) {
                        p = 0
                    }
                    return p
                }
            ...
            can_Insert_Query: function(s) {
                var q = this,
                    r = q.results[0][0],
                    p = q.getResult()[0];
                if (q.HTML[s] || (s === 0 && r !== null && !q.isRange(
                        r)) || (s === 0 && p && !q.isRange(p))) {
                    return 0
                }
            ...
            insertJavaTag: function(y, z, p, s, D) {
                ...
                var u = ["archive", x, "code", v],
                    ...
                    r = ["mayscript", "true"],
                    C = ["scriptable", "true", "codebase_lookup",
                        "false"
                    ].concat(r),
                    B = t.navigator,
                    q = !j.browser.isIE && B.mimeObj && B.mimeObj.type ?
                    B.mimeObj.type : t.mimeType[0];
                if (y == 1) {
                    return j.browser.isIE ? j.DOM.insert("object", [
                            "type", q
                        ].concat(E), ["codebase", w].concat(u)
                        .concat(
                            C), p, t, 0, z) : j.DOM.insert(
                        "object", [
                            "type", q
                        ].concat(E), ["codebase", w].concat(u)
                        .concat(
                ...
                if (y == 2) {
                    return j.browser.isIE ? j.DOM.insert("applet", [
                            "alt", p
                        ].concat(r)
                        .concat(u)
                        .concat(E), [
                            "codebase", w
                        ].concat(C), p, t, 0, z) : j.DOM.insert(
                        "applet", ["codebase", w, "alt", p].concat(
                            r)
                        .concat(u)
                        .concat(E), [].concat(C),
                        p, t, 0, z)
                ...
                if (y == 4) {
                    return j.DOM.insert("embed", ["codebase", w].concat(
                            u)
                        .concat(["type", q])
                        .concat(C)
                        .concat(
            ...
            insert_Query_Any: function(u) {
                ...
                if (j.DOM.isEnabled.objectTag()) {
                    if (!t.DummyObjTagHTML && (w[1] || w[2])) {
                        t.DummyObjTagHTML = j.DOM.insert("object", [
                            "type", s.mimeType_dummy
                        ], [], r)
                    }
                    if (!t.DummyObjTagHTML2 && w[3]) {
                        t.DummyObjTagHTML2 = j.DOM.insert("object", [
                            "classid", s.classID_dummy
                        ], [], r)
                    }
                }
                s.NOTF.init();
        ...
        NOTF: {
            ...
            init: function() {
                ...
                if (p.OTF < 3 && q.shouldContinueQuery()) {
                    p.OTF = 3;
                    if (!j.win.loaded) {
                        j.win.loadPrvtHndlrs.push([q.onWinLoadQuery,
                            q
                        ])
                    }
            ...
            shouldContinueQuery: function() {
                ...
                for (q = 0; q < r.results.length; q++) {
                    if (r.HTML[q]) {
                        if (!j.win.loaded && u.count > u.countMax &&
                            j.codebase.pluginMayBeHanging(r.HTML[q]
                                .span)) {
                            t = 1;
                            r.HTML[q].DELETE = 1
                        }
                        if (!t && !r.results[q][0] && (r.allowed[q] >=
                                2 || (r.allowed[q] == 1 && !r.getResult()[
                                    0])) && u.isAppletActive(q) >=
                            0) {
                            p = 1
                        }
                    }
            ...
            isAppletActive: function(t, u) {
                ...
                y = j.DOM.getTagStatus(w, p.DummySpanTagHTML, p.DummyObjTagHTML,
                    p.DummyObjTagHTML2, v.count, v.winLoaded);
                ...
                if (y != 1) {
                    ...
                    if (j.browser.isIE || (q.version0 && A.javaEnabled() &&
                            A.mimeObj && (w.tagName == "object" ||
                                r))) {
                        B = 1
                    } else {
                        B = 0
            ...
            onWinLoadQuery: function(p, q) {
                p.ev.setTimeout(q.onWinLoadQuery2, Math.floor(q.intervalLength /
                    2))
            },
    ...
    var m = {
        getVersion: function() {
            var r = this,
                p = null,
                q;
            if ((!q || j.dbug) && r.nav.query()
                .installed) {
                q = 1
            }
            if ((!p || j.dbug) && r.nav.query()
                .version) {
                p = r.nav.version
            }
            if ((!q || j.dbug) && r.axo.query()
                .installed) {
                q = 1
            }
            if ((!p || j.dbug) && r.axo.query()
                .version) {
                p = r.axo.version
            }
        ...
        nav: {
            ...
            query: function() {
                var s = this,
                    p, r, q = s.hasRun || !j.hasMimeType(s.mimeType);
                s.hasRun = 1;
                if (q) {
                    return s
                }
        ...
        axo: {
            ...
            installed: 0,
            version: null,
            progID: ["DevalVRXCtrl.DevalVRXCtrl",
            ...
            query: function() {
                ...
                if (u && j.DOM.isEnabled.objectTagUsingActiveX()) {
                    r = j.pd.getPROP(j.DOM.insert("object", [
                            "classid", s.classID
                        ], ["src", ""], "", v)
                        .obj(),
                        "pluginversion");
                    if (r && r.toString) {
                        ...
                        q = parseInt(q.substr(0, 2) || "0", 16) +
                            "," + parseInt(q.substr(2, 2) || "0",
                                16) + "," + parseInt(q.substr(4, 2) ||
                                "0", 16) + "," + parseInt(q.substr(
                                6, 2) || "0", 16);
                        if (q) {
                            s.version = q
                        }
    ...
    var e = {
        ...
        getVersion: function(t, q) {
            var r = this,
                p = null,
                s = 0;
            if ((!s || j.dbug) && r.navPlugin.query()
                .installed) {
                s = 1
            }
            if ((!p || j.dbug) && r.navPlugin.query()
                .version) {
                p = r.navPlugin.version
            }
            if ((!s || j.dbug) && r.axo.query()
                .installed) {
                s = 1
            }
            if ((!p || j.dbug) && r.axo.query()
            ...
            if (((!s && !p) || q || j.dbug) && r.instance.query()
                .version) {
                s = 1;
        ...
        instance: {
            ...
            isEnabled: function() {
                var q = this,
                    ...
                    p = 1;
                if (q.hasRun || j.DOM.isEnabled.objectTagUsingActiveX() ||
                    !j.DOM.isEnabled.objectTag() || !j.hasMimeType(
                        r.mimeType)) {
                    p = 0
                }
                return p
            ...
            query: function() {
                ...
                p.hasRun = 1;
                if (q) {
                    p.HTML = j.DOM.insert("object", ["type", r.mimeType], [
                        "play", "false", "menu", "false"
                    ], "", r);
                    try {
                        p.version = j.getNum(p.HTML.obj()
                            .GetVariable(
                                "$version") + "");
                    } catch (s) {}
                }
    ...
    var k = {
        ...
        axo: {
            ...
            installed: null,
            version: null,
            progID: ["SWCtl.SWCtl", "SWCtl.SWCtl.1", "SWCtl.SWCtl.7",
                "SWCtl.SWCtl.8", "SWCtl.SWCtl.11", "SWCtl.SWCtl.12"
            ],
            classID: "clsid:166B1BCA-3F9C-11CF-8075-444553540000",
            query: function() {
                var t = this,
                    v, p, q, w, s, r = !t.hasRun;
                t.hasRun = 1;
                if (r) {
    ...
    var o = {
        ...
        getVersion: function(t, q) {
            ...
            if (((!s && !p) || q || j.dbug) && r.FirefoxPlugin.query()
                .version) {
                s = 1;
        ...
        mimeType: ["application/x-ms-wmp", "application/asx",
            "application/x-mplayer2", "video/x-ms-asf",
            "video/x-ms-wm", "video/x-ms-asf-plugin"
        ],
        find: [
        ...
        plugins: ["Microsoft" + String.fromCharCode(174) +
        ...
        FirefoxPlugin: {
            ...
            isDisabled: function() {
                var p = this,
                    r = o,
                    q = j.browser;
                if (p.hasRun || (q.isGecko && j.compareNums(q.verGecko,
                        j.formatNum("1.8")) < 0) || (q.isOpera && j
                        .compareNums(q.verOpera, j.formatNum("10")) <
                        0) || j.DOM.isEnabled.objectTagUsingActiveX() ||
                    !j.hasMimeType(r.mimeType) || !j.pd.findNavPlugin({
                        find: r.find[0],
                        avoid: r.avoid,
                        mimes: r.mimeType,
                        plugins: r.plugins[0]
            ...
            query: function() {
                ...
                p = j.pd.getPROP(j.DOM.insert("object", ["type", j.hasMimeType(
                            r.mimeType)
                        .type, "data", ""
                    ], [
                        "src", ""
    ...
    var h = {
        ...
        nav: {
            ...
            query: function() {
                ...
                if (q) {
                    ...
                    if (parseInt(p[0], 10) < 2 && parseInt(p[2], 10) >=
                        30226) {
                        p[0] = "2"
                    }
                    q = p.join(",")
        ...
        axo: {
            ...
            IsVersionSupported: function(s, q) {
                var p = this;
                try {
                    return p.testVersion ? j.compareNums(j.formatNum(
                        p.testVersion.join(",")), j.formatNum(
                        q.join(","))) >= 0 : s.IsVersionSupported(
                        p.format(q))
                } catch (r) {}
                return 0
            },
            format: function(q) {
                var p = this;
                return (q[0] + "." + q[1] + "." + q[2] + p.make2digits(
                    q[3]) + p.make2digits(q[4]) + "." + q[5])
            },
            ...
            query: function() {
                ...
                if (v && r.IsVersionSupported(v, r.mindigit)) {
                    ...
                    for (q = 0; q < r.maxdigit.length; q++) {
                        u = 0;
                        while (r.maxdigit[q] - r.mindigit[q] > 1 &&
                            u < 20) {
                            u++;
                            t++;
                            p[q] = Math.round((r.maxdigit[q] + r.mindigit[
                                q]) / 2);
    ...
    var f = {
        compareNums: function(s, r) {
            ...
            for (w = 0; w < Math.min(A.length, y.length); w++) {
                ...
                v = (w == 2 && RegExp.$2.length > 0) ? RegExp.$2.charCodeAt(
                    0) : -1;
                z = /([\d]+)([a-z]?)/.test(y[w]);
                p = parseInt(RegExp.$1, 10);
                u = (w == 2 && RegExp.$2.length > 0) ? RegExp.$2.charCodeAt(
                    0) : -1;
                if (q != p) {
                    return (q > p ? 1 : -1)
                }
        ...
        setPluginStatus: function(r, p, s) {
            var q = this;
            q.installed = p ? 1 : (s ? (s > 0 ? 0.7 : -0.1) : (r ?
                0 : -1));
            if (p) {
                q.version = j.formatNum(p)
            }
            q.getVersionDone = q.installed == 0.7 || q.installed ==
                -0.1 ? 0 : 1;
            j.codebase.emptyGarbage();
        },
        getVersion: function(s) {
            var t = this,
                r, p = null,
                q;
            if ((!r || j.dbug) && t.nav.query()
                .installed) {
                r = 1
            }
            if ((!p || j.dbug) && t.nav.query()
                .version) {
                p = t.nav.version
            }
            if ((!r || j.dbug) && t.axo.query()
                .installed) {
                r = 1
            }
            if ((!p || j.dbug) && t.axo.query()
                .version) {
                p = t.axo.version
            }
            if (!p || j.dbug) {
        ...
        nav: {
            ...
            mimeType: ["application/x-vlc-plugin",
                ...
                "application/x-matroska", "application/xspf+xml",
                "video/divx", "video/webm", "video/x-mpeg",
                "video/x-msvideo", "video/ogg", "audio/x-flac",
                "audio/amr", "audio/amr"
            ],
            find: "VLC.*Plug-?in",
            find2: "VLC|VideoLAN",
        ...
        axo: {
            ...
            query: function() {
                ...
                if (s) {
                    q.installed = 1;
                    p = j.getNum(j.pd.getPROP(s, "VersionInfo"),
                        "[\\d][\\d\\.]*[a-z]*");
                    if (p) {
                        q.version = p
                    }
    ...
    var c = {
        setPluginStatus: function() {
            ...
            r = v ? 1 : (r ? 0 : -1);
            if (r == -1) {
                r = u == -0.5 || x == -0.5 ? -0.15 : (j.browser.isIE &&
                    (!j.browser.ActiveXEnabled || j.browser.ActiveXFilteringEnabled) ?
                    -1.5 : -1)
            }
            t.installed = r;
        },
        getVersion: function() {
            var p = this,
                q = 0;
            if ((!q || j.dbug) && p.nav.query()
                .version) {
                q = 1
            }
            if ((!q || j.dbug) && p.axo.query()
                .version) {
                q = 1
            }
            if ((!q || j.dbug) && p.doc.query()
                .version) {
                q = 1
            }
            p.setPluginStatus()
        ...
        axo: {
            detected: 0,
            version: null,
            progID: ["AcroPDF.PDF", "AcroPDF.PDF.1", "PDF.PdfCtrl",
                "PDF.PdfCtrl.5", "PDF.PdfCtrl.1"
            ],
            ...
            query: function() {
                ...
                for (p = 0; p < s.progID.length; p++) {
                    ...
                    if (t) {
                        ...
                        if (u && j.errObj && u !== j.errObj && u.message !==
                            j.errObj.message) {
                            s.detected = -0.5
                        }
                    }
        ...
        doc: {
            ...
            query: function() {
                ...
                if (!u.DummySpanTagHTML) {
                    u.DummySpanTagHTML = j.DOM.insert("", [], [], r,
                        p, t)
                }
                if (!u.HTML) {
                    u.HTML = j.DOM.insert("object", ["classid", u.classID], [],
                        r, p, t)
                }
                if (!u.DummyObjTagHTML2) {
                    u.DummyObjTagHTML2 = j.DOM.insert("object", [
                        "classid", u.classID_dummy
                    ], [], r, p, t)
                }
                v = j.DOM.getTagStatus(u.HTML, u.DummySpanTagHTML,
                    u.DummyObjTagHTML1, u.DummyObjTagHTML2, 0,
                    0, s);
                q = p.activexQuery(u.HTML.obj());
                u.detected = v > 0 || q ? 1 : (v == -0.1 || v == -
                    0.5 ? -0.5 : -1);
                u.version = q ? q : null;
                return u
            }
    ...
    var l = {
        ...
        setPluginStatus: function() {
            ...
            if (q == 3) {
                ...
                s = s ? 0 : -1;
                if (s == -1) {
                    s = r == -0.5 || u == -0.5 ? -0.15 : (j.browser
                        .isIE && (!j.browser.ActiveXEnabled ||
            ...
            if (p.verify && p.verify.isEnabled()) {
                ...
                if (p.getVersionDone != 1) {
                    p.getVersionDone = (p.installed == -0.5 || (p.installed ==
                        -1 && p.doc.isDisabled() < 2)) ? 0 : 1
                }
            }
        },
        getVersion: function(s, r, t) {
            ...
            if (p.getVersionDone === 0) {
                if (u && u.isEnabled() && j.isNum(p.installed) && p
                    .installed >= 0) {
                    return
                }
        ...
        axo: {
            ...
            progID_dummy: "AcroDUMMY.DUMMY",
            prodID3rd: ["NitroPDF.IE.ActiveDoc",
                "PDFXCviewIEPlugin.CoPDFXCviewIEPlugin",
                "PDFXCviewIEPlugin.CoPDFXCviewIEPlugin.1",
                "FoxitReader.FoxitReaderCtl",
                "FoxitReader.FoxitReaderCtl.1",
                "FOXITREADEROCX.FoxitReaderOCXCtrl",
                "FOXITREADEROCX.FoxitReaderOCXCtrl.1"
            ],
            query: function() {
                var r = this,
                    q = l,
                ...
                if (!r.result) {
                    ...
                    for (p = 0; p < r.progID.length; p++) {
                        if (j.getAXO(r.progID[p])) {
                            ...
                            if (s && j.errObj && s !== j.errObj &&
                                s.message !== j.errObj.message) {
                                r.result = -0.5
                            }
                        }
                    }
        ...
        doc: {
            ...
            isDisabled: function() {
                ...
                if (p.OTF >= 2 || !j.DOM.isEnabled.objectTag()) {
                    ...
                    if (j.dbug || j.hasMimeType(t.mimeType)) {} else {
                        if ((q.isGecko && j.compareNums(q.verGecko,
                                    j.formatNum("10")) <= 0 && j.OS <=
                                4) || (q.isOpera && j.compareNums(q
                                    .verOpera, j.formatNum("11")) <=
                                0 && j.OS <= 4) || (q.isChrome && j
                                .compareNums(q.verChrome, j.formatNum(
                                    "10")) < 0 && j.OS <= 4)) {
                            s = 2
                        }
                    }
            ...
            queryObject: function(s, r) {
                var u = this,
                    ...
                    p = 0,
                    t = 1;
                p = j.DOM.getTagStatus(u.HTML, u.DummySpanTagHTML,
                    u.DummyObjTagHTML1, 0, s, r, t);
                u.result = p;
                return p
            },
            insertHTMLQuery: function() {
                ...
                r = j.file.getValid(p)
                    .full;
                if (!t.DummySpanTagHTML) {
                    t.DummySpanTagHTML = j.DOM.insert("", [], [], q,
                        p, s)
                }
                if (!t.HTML) {
                    t.HTML = j.DOM.insert("object", (j.browser.isIE &&
                            !p.detectIE3P ? ["classid", t.classID] :
                            ["type", t.mimeType])
                        .concat([
                            "data", r
                        ]), ["src", r], q, p, s)
                ...
                if (!t.DummyObjTagHTML1) {
                    t.DummyObjTagHTML1 = j.DOM.insert("object", (j.browser
                            .isIE && !p.detectIE3P ? ["classid",
                                t.classID_dummy
                            ] : ["type", t.mimeType_dummy]), [],
                        q, p, s)
                }
                t.queryObject();
                if (j.browser.isIE && t.result === 0) {
                    t.HTML.span.innerHTML = t.HTML.outerHTML;
                    t.DummyObjTagHTML1.span.innerHTML = t.DummyObjTagHTML1
                        .outerHTML;
                    t.queryObject()
                }
        ...
        NOTF: {
            ...
            init: function() {
                ...
                if (p.OTF < 3 && q.HTML) {
                    p.OTF = 3;
                    if (!j.win.loaded) {
                        j.win.loadPrvtHndlrs.push([r.onWinLoadQuery,
                            r
                        ])
                    }
            ...
            onIntervalQuery: function() {
                ...
                if (l.OTF == 3) {
                    ...
                    if (p.result > 0 || p.result < -0.1 || (j.win.loaded &&
                            q.count > q.countMax)) {
                        q.queryCompleted()
                    }
                }
        ...
        getInfo: function() {
            var q = this,
                p = {
                    ...
                    DummyPDFused: (q.doc.result > 0 ? true : false)
                };
            return p
        }
    };
    ...
    var n = {
        ...
        navObj: {
            ...
            query: function() {
                ...
                if (p) {
                    ...
                    if (r && j.compareNums(j.formatNum(r), j.formatNum(
                            "15")) >= 0) {
                        q.version = r
                    }
                }
        ...
        JS: {
            ...
            convertNum: function(t, q, w) {
                ...
                if (v.compare(u.slice(0, Math.min(q[0].length, u.length)),
                        q[0]) !== 0) {
                    return r
                }
                s = u.length > q[0].length ? u.slice(q[0].length) :
                    [];
                if (v.compare(s, q[1]) > 0 || v.compare(s, q[q.length -
                        1]) < 0) {
                    return r
                }
                for (p = q.length - 1; p >= 1; p--) {
                    ...
                    if (v.compare(q[p], s) === 0 && v.compare(q[p],
                            q[p - 1]) === 0) {
                        break
                    }
                    if (v.compare(s, q[p]) >= 0 && v.compare(s, q[p -
                            1]) < 0) {
                        break
                    }
                }
            ...
            isEnabled: function() {
                var p = this;
                return !p.hasRun && j.OS == 1 && j.hasMimeType(p.mimetype) ?
                    1 : 0
            },
            query: function() {
                var u = this,
                ...
                if (p) {
                    ...
                    if (t) {
                        ...
                        if (u.compare(q, [6, 0, 12, 200]) < 0) {
                            ...
                            if (u.compare(q, [6, 0, 12, 1739]) <= 0 &&
                                u.compare(q, [6, 0, 12, 857]) >= 0) {
                                s = -1
                            }
                        }
                        if (s < 0) {
        ...
        instance: {
            ...
            isEnabled: function() {
                ...
                if (!j.DOM.isEnabled.objectTag()) {
                    ...
                    if (j.dbug) {} else {
                        if (q.hasRun || j.DOM.isEnabled.objectTagUsingActiveX() ||
                            !j.hasMimeType(r.mimeType) || (j.browser
                                .isGecko && j.compareNums(j.browser
                                    .verGecko, j.formatNum("1,8")) <
                                0) || (j.browser.isOpera && j.compareNums(
                                j.browser.verOpera, j.formatNum(
                                    "10")) < 0)) {
                            p = 0
                        }
                    }
            ...
            query: function() {
                ...
                p.hasRun = 1;
                if (q) {
                    p.HTML = j.DOM.insert("object", ["type", t.mimeType[
                        0]], ["src", "", "autostart",
                        "false", "imagestatus", "false",
                        "controls", "stopbutton"
                    ], "", t);
                    s = p.HTML.obj();
                    try {
        ...
        axo: {
            ...
            installed: null,
            version: null,
            progID: ["rmocx.RealPlayer G2 Control",
        ...
        getVersion: function(s, q) {
            ...
            if ((!r || j.dbug) && t.navObj.query()
                .installed) {
                r = 1
            }
            if ((!p || j.dbug) && t.navObj.query()
                .version) {
                p = t.navObj.version
            }
            if ((!p || j.dbug) && t.JS.query()
                .version) {
                r = 1;
                p = t.JS.version
            }
            if (((!r && !p) || q || j.dbug) && t.instance.query()
                .version) {
                r = 1;
    ...
    var g = {
        ...
        getVersion: function(t, r) {
            ...
            if (!q.obj) {
                ...
                try {
                    q.obj.style.behavior =
                        "url(#default#clientcaps)"
                } catch (u) {}
            }
            try {
                p = q.obj.getComponentVersion(r, "componentid")
                    .replace(
                        /,/g, ".")
            } catch (u) {}
            try {
                if (!p) {
                    s = q.obj.isComponentInstalled(r, "componentid") ?
                        1 : 0
                }
            } catch (u) {}
    ...
    var d = {
        ...
        clone: function(u, r) {
            var v = this,
                q, p, s = 0,
                t = 20;
            if (j.isNum(u) || j.isString(u) || u === null || j.isFunc(
                    u) || u === j || u === j.Plugins || u === v) {
                return u
            } else {
        ...
        setPluginStatus: function(s, p, q) {
            ...
            r.getVersionDone = 0;
            r.version = j.formatNum(p);
            r.installed = p ? 1 : (s ? (s > 0 ? 0.7 : -0.1) : (q ?
                -3 : -1));
            j.codebase.emptyGarbage();
        },
        getVersion: function(t, u, y) {
            ...
            if (j.isArray(y)) {
                ...
                if (p && z.storage[p]) {
                    ...
                    r = 0;
                    for (w = 0; w < Math.max(y.length, s.DIGITMAX[0]
                            .length); w++) {
                        if ((w < y.length ? y[w] : 0) > (w < s.DIGITMAX[
                                    0].length ? s.DIGITMAX[0][w] :
                                0)) {
                            r = 1;
                            break
                        }
                    ...
                    if (r && s.version) {
                        ...
                        for (w = 0; w < Math.max(r.length, s.DIGITMAX[
                                0].length); w++) {
                            if ((w < r.length ? r[w] : 0) === (w <
                                    s.DIGITMAX[0].length ? s.DIGITMAX[
                                        0][w] : 0)) {
                                z.storage[p] = null;
                                break
                            }
    ...
    var b = {
        ...
        setPluginStatus: function() {
            ...
            if (q.verify && q.verify.isEnabled()) {
                ...
                if (q.getVersionDone != 1) {
                    q.getVersionDone = (q.installed == -0.5 || (q.installed ==
                        -1 && q.doc.isDisabled() < 2)) ? 0 : 1
                }
            }
        },
        getVersion: function(r, q) {
            ...
            if (s.getVersionDone === 0) {
                if (u && u.isEnabled() && j.isNum(s.installed) && s
                    .installed >= 0) {
                    return
                }
            }
        ...
        doc: {
            ...
            isDisabled: function() {
                var t = this,
                    ...
                    p = j.browser,
                    q;
                if (s.OTF >= 2 || !j.DOM.isEnabled.objectTag() || j
                    .DOM.isEnabled.objectTagUsingActiveX()) {
                    r = 2
                } else {
                    if (j.dbug) {} else {
                        if (!p.isGecko || j.compareNums(p.verGecko,
                                j.formatNum("10")) < 0 || (j.compareNums(
                                    p.verGecko, j.formatNum("19")) <
                                0 && j.hasMimeType(t.mimeType))) {
                            r = 2
                        }
                    }
                }
            ...
            queryObject: function(s, p) {
                var v = this,
                    ...
                    w, r, q = j.dbug && !j.win.loaded ? 0 : 1;
                w = j.DOM.getTagStatus(v.HTML, v.DummySpanTagHTML,
                    v.DummyObjTagHTML1, 0, s, p);
                ...
                if ((!v.result || j.dbug) && w > 0 && !j.hasMimeType(
                        v.mimeType)) {
                    if (q) {
                        v.result = 1
                    }
                ...
                if ((!v.result || j.dbug) && w > 0 && j.isNum(r) &&
                    j.isNum(v.tabIndex) && v.tabIndex !== r) {
                    if (q) {
                        v.result = 1
                    }
                    v.method += "4,";
            ...
            insertHTMLQuery: function() {
                ...
                q = j.file.getValid(r)
                    .full;
                if (!t.DummySpanTagHTML) {
                    t.DummySpanTagHTML = j.DOM.insert("", [], [], p,
                        r, s)
                }
                if (!t.HTML) {
                    t.HTML = j.DOM.insert("object", ["type", t.mimeType,
                        "data", q
                    ], ["src", q], p, r, s)
                }
                if (!t.DummyObjTagHTML1) {
                    t.DummyObjTagHTML1 = j.DOM.insert("object", [
                        "type", t.mimeType_dummy
                    ], [], p, r, s)
                }
                t.queryObject();
